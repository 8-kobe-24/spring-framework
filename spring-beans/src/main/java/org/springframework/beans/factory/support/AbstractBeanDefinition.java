...
public abstract class AbstractBeanDefinition extends BeanMetadataAttributeAccessor
	...
	/**
	 * autowire-candidate属性设置为false，这样容器在查找字段装配对象时，将不考虑该bean，即它不会被
	 * 考虑作为其他bean自动装配的候选者吗，但是该bean本身还是可以使用自动装配来注入其他bean
	 */
	...
	/**
	 * 是否以一种宽松的模式即系构造函数，默认为true，
	 * 如果为false，Spring在无法准确定位哪个构造函数程序设置
	 */
	...
	/**
	 * 是否时用户定义的而不是程序本身定义的，创建AOP时候为true，程序设置
	 */
